...
void main() {
	...
	*/
		...
		if (flixel_texture2D(bitmap, vec2((openfl_TextureCoordv.x - borderWidth), openfl_TextureCoordv.y)).a != 0.)// || flixel_texture2D(bitmap, vec2((openfl_TextureCoordv.x + borderWidth), openfl_TextureCoordv.y)).a != 0.)
		{
			r = 0.3;
		}
		
		//do the same for blue, but at a different offset
		if (flixel_texture2D(bitmap, vec2((openfl_TextureCoordv.x - borderWidth*0.5), (openfl_TextureCoordv.y + borderWidth*0.5))).a != 0.)// || flixel_texture2D(bitmap, vec2((openfl_TextureCoordv.x - borderWidth*0.5), (openfl_TextureCoordv.y + borderWidth*0.5))).a != 0.)
		{
			g = 0.3;
		}
		...
		if (flixel_texture2D(bitmap, vec2((openfl_TextureCoordv.x), (openfl_TextureCoordv.y - borderWidth))).a != 0.)// || flixel_texture2D(bitmap, vec2((openfl_TextureCoordv.x), (openfl_TextureCoordv.y + borderWidth))).a != 0.)
		{
			b = 0.3;
		}
